    ...
    >
      <section className={s.grid}>
        <FactRow
          ...
          text="Доступ к личному кабинету, VPN-ссылке, выбору доступного сервера, статистике трафика и базовой технической поддержке."
        />
        <FactRow
      ...
      <Card className={s.sectionCard}>
        ...
        <p className={s.text}>
          ...
          Пользователь обязан соблюдать законодательство применимой юрисдикции
    ...
    >
      <section className={s.grid}>
        ...
        <FactRow
          ...
          text="Обращения по возврату рассматриваются в течение 3 рабочих дней с момента получения всей необходимой информации."
        />
        <FactRow
          icon={CreditCard}
        ...
        <FactRow
          ...
          text="Возврат может быть отклонен, если услуга была фактически оказана, доступ активирован и пользователь начал пользоваться сервисом, кроме случаев технической невозможности оказания услуги."
        />
      </section>
      ...
      <Card className={s.sectionCard}>
        ...
        <p className={s.text}>
          ...
          поддержку. После активации доступа вопрос решается индивидуально с
          учетом факта оказания услуги.
        </p>
      </Card>
    </LegalLayout>
  );
    ...
    >
      <Card className={s.sectionCard}>
        ...
        <p className={s.text}>
          ...
          VPN-сервису и личному кабинету, а пользователь оплачивает доступ и
          использует сервис на условиях настоящей оферты.
        </p>
      </Card>
      ...
      <Card className={s.sectionCard}>
        ...
        <p className={s.text}>
          ...
          пользователь получает доступ к личному кабинету, VPN-ссылке и
          доступным настройкам подключения. Физическая доставка не
          осуществляется.
        </p>
      </Card>
    ...
    >
      ...
      <Card className={s.sectionCard}>
        ...
        <p className={s.text}>
          ...
          Оплата может выполняться через платежного провайдера <strong>lava.ru</strong>, который
          обрабатывает платежную информацию по своим правилам и документам. В
          сервисе может храниться только служебная информация о факте оплаты,
          сроке подписки или статусе доступа, необходимая для предоставления
          услуги.
        </p>
      </Card>
      ...
      <Card className={s.sectionCard}>
        ...
        <p className={s.text}>
          Пользователь может запросить удаление аккаунта через поддержку. Запрос на 
          удаление аккаунта обрабатывается в течение 1 дня с момента получения обращения.
        </p>
        <div className={s.bulletList}>
          {dataRights.map((item) => (
            <div key={item} className={s.bulletItem}>
