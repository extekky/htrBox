...
function Note({
    ...
    return (
        <div className={cn(
            ...
            <Info
                size={13}
                className={cn("shrink-0 mt-0.5", isAmber ? "text-amber-500" : "text-muted-foreground")}
            />
            <span>{children}</span>
        </div>
    );
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        >
                            <div className="flex flex-col gap-3 pt-3">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {[
                                        { icon: <KeyRound size={14} />, label: "Уникальная ссылка подключения" },
                                        { icon: <Activity size={14} />, label: "Статистика трафика" },
                                        { icon: <Clock size={14} />, label: "Дата истечения подписки" },
                                ...
                                <Note>
                                    Аккаунт создаётся при регистрации. Администратор активирует доступ после оплаты.
                                </Note>
                            </div>
                        </Section>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    ...
                                    <div className="flex flex-col gap-3 p-4 bg-emerald-500/8 border border-emerald-500/20 rounded-2xl">
                                        ...
                                        <div className="flex items-end gap-1">
                                            <span className="text-3xl font-black text-foreground leading-none">200</span>
                                            <span className="text-sm text-muted-foreground mb-0.5">₽ / мес</span>
                                        </div>
                        ...
                        >
                            <div className="flex flex-col gap-3 pt-3">
                                ...
                                <Note variant="amber">
                                    Ответ в течение дня. Укажите ваш логин при обращении — это ускорит ответ.
                                </Note>
                            </div>
                        </Section>
