    ...
    return (
        <div className="relative w-14 h-14 shrink-0">
            ...
            >
                ...
                {/* Wings */}
                <ellipse cx="20" cy="65" rx="10" ry="18" fill="#A0845C" transform="rotate(-10 20 65)" />
                <ellipse cx="80" cy="65" rx="10" ry="18" fill="#A0845C" transform="rotate(10 80 65)" />
                ...
                {/* Chest pattern */}
                <path d="M42 65 Q50 70 58 65" stroke="#DFC49A" strokeWidth="1.5" fill="none" />
                <path d="M40 72 Q50 77 60 72" stroke="#DFC49A" strokeWidth="1.5" fill="none" />
                <path d="M42 79 Q50 84 58 79" stroke="#DFC49A" strokeWidth="1.5" fill="none" />
...
export function PenguinAvatar() {
    return (
        <div className="relative w-14 h-14 shrink-0">
            ...
            >
                {/* Wings */}
                <ellipse cx="20" cy="60" rx="8" ry="18" fill="#2D3748" transform="rotate(-15 20 60)" />
                <ellipse cx="80" cy="60" rx="8" ry="18" fill="#2D3748" transform="rotate(15 80 60)" />
