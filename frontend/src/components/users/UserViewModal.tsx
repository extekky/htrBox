import { ShieldCheck, ShieldOff, CircleCheck, CircleX, CheckCircle2 } from "lucide-react";
...
import { toGB, formatDate, formatTime, formatDaysLeft, getExpiryTier } from "@/lib/formatters";
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2 p-3.5 rounded-xl bg-muted/40 border border-border/50">
                    <div className="flex items-center justify-between">
                        <span className="text-xs text-muted-foreground">Использовано трафика</span>
                ...
                <div className="flex flex-col px-0.5">
                    ...
                    <InfoRow label="Подписка">
                        {user.active
                            ? <span className="flex items-center gap-1 text-primary"><ShieldCheck size={12} /> Активна</span>
                            : <span className="flex items-center gap-1 text-muted-foreground"><ShieldOff size={12} /> Неактивна</span>
                        }
                    </InfoRow>
                </div>
